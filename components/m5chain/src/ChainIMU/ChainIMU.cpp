...
chain_status_t ChainIMU::imuI2cMemRead(uint8_t id, uint8_t i2cAddr, uint16_t regAddr,
                                       chain_imu_i2c_reg_len_t regLength, uint8_t readLength, uint8_t *buffer,
...
{
    return CHAIN_IMU_DEVICE_TYPE_CODE;
}
